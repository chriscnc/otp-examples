defmodule KVServer do
  ...
  def accept(port) do
    ...
    #
    # 1. `:binary` - recieves data as binaries (instead of lists)
    # 2. `package: :line` - receives data line by line
    # 3. `active: false` - blocks on `:gen_tcp.recv/2` until data is available
    # 4. `reuseaddr: true` - allos us to reuse the address if the listener crashes
    #
